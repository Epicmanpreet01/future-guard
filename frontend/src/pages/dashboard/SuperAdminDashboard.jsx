                ...
                <div className="flex bg-gray-200 rounded-lg h-8 overflow-hidden text-sm">
                  ...
                  >
                    {globalInstituteStats.active > 0 && (
                      <span className="font-medium text-green-700">{globalInstituteStats.active} Active</span>
                    )}
                  </div>
                  <div
                  ...
                  >
                    {globalInstituteStats.inactive > 0 && (
                      <span className="font-medium text-red-700">{globalInstituteStats.inactive} Inactive</span>
                    )}
                  </div>
                </div>
              </div>
